...
export default async function OpportunityReportPage() {
  ...
  return <main className="sekur-intelligence min-h-screen text-white"><SiteHeader /><section className="mx-auto max-w-7xl px-5 py-12 sm:px-6 sm:py-16"><OpportunityReportGate careers={careers} /></section></main>;
}
