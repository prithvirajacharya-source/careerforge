...
export default async function ProPage({ searchParams }: { searchParams: Promise<{ checkout?: string }> }) {
  ...
  return <main className="sekur-intelligence min-h-screen text-white"><SiteHeader /><section className="mx-auto max-w-5xl px-5 py-16">
    <div className="mx-auto max-w-2xl text-center"><p className="product-eyebrow">SEKUR Pro</p><h1 className="mt-3 text-4xl font-black sm:text-5xl">Make better career decisions.</h1><p className="mt-4 leading-7 text-slate-400">Know your strongest opportunities, why they fit, what is holding you back, and when the evidence changes.</p></div>
