...
export const CAREER_RESEARCH_COUNTRY_SOURCES: CareerResearchCountrySource[] = [
  ...
  { slug: "denmark", name: "Denmark", code: "DK", nativeCurrency: "DKK", marketType: "country", sourceSystem: "Statistics Denmark StatBank table LONS20", sourceUrl: "https://www.statbank.dk/LONS20", automationStatus: "discovery", methodology: "Official hourly lower quartile, median, and upper quartile by DISCO-08 occupation", refreshAfterDays: 365, disabledReason: "LONS20 is validated and CC BY 4.0, but it publishes hourly quartiles. SEKUR's current annual-salary contract cannot store them without an unsupported hours-worked conversion." },
  ...
  { slug: "canada", name: "Canada", code: "CA", nativeCurrency: "CAD", marketType: "country", sourceSystem: "Government of Canada Job Bank open wage data", sourceUrl: "https://open.canada.ca/data/en/dataset/adad580f-76b0-4502-bd05-20c125de9116", automationStatus: "discovery", methodology: "Official national hourly 10th percentile, median, and 90th percentile wages by NOC", refreshAfterDays: 365, disabledReason: "The official annual CSV retrieval path is validated, but most target wages are hourly. SEKUR's current annual-salary contract cannot store them without an unsupported hours-worked conversion." },
];
